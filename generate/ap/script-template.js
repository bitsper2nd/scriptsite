// ==UserScript==
// @name         Anti Paywall
// @namespace    liamengland1
// @version      {{.version}}
// @description  Block paywalls using Liam England's Anti Paywall Filter List
// @author       liamengland1
// @match        *://*/*
// @grant        none
...
/// @stats {{.statistics}}
{
    let log = function (...data) {
        console.log("[Antipaywall filters by liamengland1 (v{{.version}})]:", ...data);
    }
